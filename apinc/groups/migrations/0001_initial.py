...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('groups_groupmembership', (
            ...
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='groups', to=orm['members.Person'])),
    ...
    models = {
        ...
        'groups.groupmembership': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'groups'", 'to': "orm['members.Person']"}),
