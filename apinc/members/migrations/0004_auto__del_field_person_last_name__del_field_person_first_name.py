...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('members_person', 'last_name')

        # Deleting field 'Person.first_name'
        db.delete_column('members_person', 'first_name')


    def backwards(self, orm):
        
        # Adding field 'Person.last_name'
        db.add_column('members_person', 'last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)

        # Adding field 'Person.first_name'
        db.add_column('members_person', 'first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)
    ...
    models = {
        ...
        'members.personrole': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 9, 2)', 'null': 'True', 'blank': 'True'})
        },
        'members.role': {
