...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('members_personrole', 'actor_id', 'person_id')


    def backwards(self, orm):
        db.rename_column('members_personrole', 'person_id', 'actor_id')
    ...
    models = {
        ...
        'members.personrole': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'roles'", 'to': "orm['members.Person']"}),
            'role': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'members'", 'to': "orm['members.Role']"}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 9, 16)', 'null': 'True', 'blank': 'True'})
        },
        'members.role': {
