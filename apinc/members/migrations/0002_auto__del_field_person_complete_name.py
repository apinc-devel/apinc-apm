...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Person.complete_name'
        db.delete_column('members_person', 'complete_name')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Person.complete_name'
        raise RuntimeError("Cannot reverse this migration. 'Person.complete_name' and its values cannot be restored.")
